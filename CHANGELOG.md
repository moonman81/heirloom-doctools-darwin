...
Upstream changelog for the pristine heirloom-doctools-080407 release is preserved
...
Initial public release of the Heirloom Documentation Tools macOS/Darwin port.

### Added / Changed / Fixed

- **9cd483a**: phase 0: Darwin mk.config overlays + top-level driver + PORT.md
- **de3ba2b**: phase 6-a: fix nroff/troff n7.c storeword LP64 SIGSEGV

### Documentation

- **0386f6b**: docs: add README + NOTICE + AI-DISCLOSURE

### Vendor baseline

- **b515591**: import pristine `heirloom-doctools-080407` upstream tarball verbatim
...
- Repository: <https://github.com/moonman81/heirloom-doctools-darwin>
...
- Vendor tarball: `heirloom-doctools-080407`
