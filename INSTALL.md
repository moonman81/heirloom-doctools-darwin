# INSTALL — troff/eqn/tbl/pic/grap/refer (Heirloom Darwin port)
...
`uninstall` reads the manifest at `.install-manifest-doctools.txt`
...
`https://github.com/moonman81/heirloom-doctools-darwin/issues`
with:
