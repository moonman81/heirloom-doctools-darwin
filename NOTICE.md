...
(arm64) port** of Gunnar Ritter's Heirloom Documentation Tools. It is
...
The commit at commit 1 (`b515591`) is a **byte-exact
reproduction** of the upstream **heirloom-doctools-080407** tarball. Every
