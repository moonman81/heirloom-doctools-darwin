...
Chain of custody for the `doctools` package (troff/eqn/tbl/pic/grap/refer) as vendored by
this Darwin port.
...
- **Upstream tarballs**: `/opt/heirloom/src/original/heirloom-doctools-*/`
...
- This port: `moonman81 (2026). heirloom-doctools-darwin.
