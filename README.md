# Heirloom Documentation Tools — macOS / Darwin port

A **downstream** Darwin (macOS 26 arm64) port of Gunnar Ritter's
Heirloom **Documentation Tools**, heirloom-doctools-080407 release.
...
- Commit 1 (`b515591`) — **pristine `heirloom-doctools-080407`** upstream tarball,
