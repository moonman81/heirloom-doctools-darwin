...
- **C sources**: coord.c, for.c, frame.c, grap.c, grapl.c, input.c, label.c, main.c, misc.c, plot.c, print.c, ticks.c (+1 more)
- **Headers**: grap.h, heirloom_flags.h, y.tab.h
