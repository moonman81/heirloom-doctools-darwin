...
picture preprocessor for troff.
...
- **C sources**: arcgen.c, blockgen.c, boxgen.c, circgen.c, for.c, input.c, linegen.c, main.c, misc.c, movegen.c, picl.c, picy.c (+5 more)
- **Headers**: heirloom_flags.h, pic.h, y.tab.h
