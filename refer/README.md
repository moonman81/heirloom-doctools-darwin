...
bibliographic reference preprocessor.
...
- **C sources**: addbib.c, deliv2.c, glue1.c, glue2.c, glue3.c, glue4.c, glue5.c, hunt1.c, hunt2.c, hunt3.c, hunt5.c, hunt6.c (+26 more)
- **Headers**: heirloom_flags.h
- **Build**: Makefile, Makefile.mk
- **Scripts**: indxbib.sh, roffbib.sh
- **Subdirs**: papers
